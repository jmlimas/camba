...
urlpatterns = [ 
    ...
    url(r'^articulo/create', views.ArticuloCreatePopup, name = "ArticuloCreate"),
    url(r'^articulo/(?P<pk>\d+)/edit', views.ArticuloEditPopup, name = "ArticuloEditP"),
    url(r'^articulo/ajax/get_articulo_id', views.get_articulo_id, name = "get_articulo_id"),
